...
public class MIBManager
{
    ...
    private string HandleDeviceGroup(IID iid, string value)
    {
        ...
        {
            case 1: // device.id
                if (value != null) throw new InvalidOperationException("[MIB Manager] device.id is read-only.");
                return _mib.Device.Id;

            case 2: // device.type
                if (value != null) throw new InvalidOperationException("[MIB Manager] device.type is read-only.");
            ...
            case 4: // device.nSensors
                if (value != null) throw new InvalidOperationException("[MIB Manager] device.nSensors is read-only.");
                return _mib.Device.NSensors.ToString();

            case 5: // device.nActuators
                if (value != null) throw new InvalidOperationException("[MIB Manager] device.nActuators is read-only.");
            ...
            case 7: // device.upTime
                if (value != null) throw new InvalidOperationException("[MIB Manager] device.upTime is read-only.");
                return _mib.Device.UpTime.ToString();

            case 8: // device.lastTimeUpdated
                if (value != null) throw new InvalidOperationException("[MIB Manager] device.lastTimeUpdated is read-only.");
                return _mib.Device.LastTimeUpdated.ToString();

            case 9: // device.operationalStatus
                if (value != null) throw new InvalidOperationException("[MIB Manager] device.operationalStatus is read-only.");
            ...
            default:
                throw new ArgumentException("[MIB Manager]$ Invalid IID object for device group.");
        }
    }
    ...
    private string HandleSensorsTable(IID iid, string value)
    {
        ...
        {
            throw new EmptyMibException("[MIB Manager] Sensors table is empty.");
        }
        ...
        if (iid.SecondIndex.HasValue)
        {
            ...
            Console.WriteLine("✅ [MIB Manager] Range processed successfully.");
    ...
    private string ProcessSensorObject(Sensor sensor, int objectId, string value)
    {
        switch (objectId)
        {
            ...
            case 2: // sensors.type
                if (value != null) throw new InvalidOperationException("[MIB Manager] sensors.type is read-only.");
                return sensor.Type;
            ...
            case 4: // sensors.minValue
                if (value != null) throw new InvalidOperationException("[MIB Manager] sensors.minValue is read-only.");
                return sensor.MinValue.ToString();

            case 5: // sensors.maxValue
                if (value != null) throw new InvalidOperationException("[MIB Manager] sensors.maxValue is read-only.");
                return sensor.MaxValue.ToString();

            case 6: // sensors.lastSamplingTime
                if (value != null) throw new InvalidOperationException("[MIB Manager] sensors.lastSamplingTime is read-only.");
                return sensor.LastSamplingTime.ToString();

            default:
                throw new ArgumentException("[MIB Manager] Invalid IID object for sensors table.");
        }
    }
    ...
    private string HandleActuatorsTable(IID iid, string value)
    {
        ...
        {
            throw new EmptyMibException("[MIB Manager] Actuators table is empty.");
        }
        ...
        if (iid.SecondIndex.HasValue)
        {
            if (iid.SecondIndex < iid.FirstIndex || iid.SecondIndex > _mib.Actuators.Actuators.Count)
                throw new ArgumentException("[MIB Manager] Invalid second index.");
    ...
    private string ProcessActuatorObject(Actuator actuator, int objectId, string value)
    {
        ...
        {
            case 1: // actuators.id
                if (value != null) throw new InvalidOperationException("[MIB Manager] actuators.id is read-only.");
                return actuator.Id;

            case 2: // actuators.type
                if (value != null) throw new InvalidOperationException("[MIB Manager] actuators.type is read-only.");
            ...
            case 4: // actuators.minValue
                if (value != null) throw new InvalidOperationException("[MIB Manager] actuators.minValue is read-only.");
                return actuator.MinValue.ToString();

            case 5: // actuators.maxValue
                if (value != null) throw new InvalidOperationException("[MIB Manager] actuators.maxValue is read-only.");
                return actuator.MaxValue.ToString();

            case 6: // actuators.lastControlTime
                if (value != null) throw new InvalidOperationException("[MIB Manager] actuators.lastControlTime is read-only.");
                return actuator.LastControlTime.ToString();

            default:
                throw new ArgumentException("[MIB Manager] Invalid IID object for actuators table.");
        }
    }
    ...
    public void UpdateOperationalStatus(int status)
    {
        _mib.Device.OperationalStatus = status;
    }
